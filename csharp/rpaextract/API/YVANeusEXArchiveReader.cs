...
/// <summary>
/// Provides an implementation of the <see cref="ArchiveReader"/> base class to support reading archives with the custom "YVANeusEX" encryption.
/// </summary>
public sealed class YVANeusEXArchiveReader : ArchiveReader {
    /// <summary>
    ///     Gets the required header of the archive to be able to parse it with the <see cref="YVANeusEXArchiveReader"/> parser.
    /// </summary>
