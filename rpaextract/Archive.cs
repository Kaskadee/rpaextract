...
namespace rpaextract
{
    ...
    internal sealed class Archive
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Archive"/> class and loads archive information from the specified file.
        /// </summary>
        ...
        /// <summary>
        /// Extracts file indicies from the archive.
        /// </summary>
        ...
        /// </summary>
        /// <param name="indices">The obfuscated archive indices.</param>
        private IEnumerable<ArchiveIndex> Deobfuscate(IEnumerable<ArchiveIndex> indices)
        {
            ...
            return indices.Select(ind => new ArchiveIndex(ind.FilePath, ind.Offset ^ _deobfuscationKey, ind.Length ^ _deobfuscationKey, ind.Prefix));
        }
        /// <summary>
        /// Calculates the deobfuscation key for this archive.
        /// </summary>
        /// <param name="splittedHeader">The splitted header array.</param>
